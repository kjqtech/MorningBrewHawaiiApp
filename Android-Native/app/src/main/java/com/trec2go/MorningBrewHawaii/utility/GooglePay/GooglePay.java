package com.trec2go.MorningBrewHawaii.utility.GooglePay;
...
public class GooglePay {
    ...
    /*private static JSONObject getTokenizationSpecification() throws JSONException {
        ...
        tokenizationSpecification.put(
                "parameters",
                new JSONObject()
                        .put("gateway", "authorize.net")
                        .put("gatewayMerchantId", "8u7qSj9H5UX"));
        ...
        tokenizationSpecification.put(
                "parameters",
                 new JSONObject()
                        ...
                        .put("publicKey", "BDn0NimshCuLixY4hyYqPKlHpCnhiZjPjz/3sUoR29vQGDz30xASwniPwBsU4/pFdcdi8j/8RZj5N44eFAgWyaM="));
